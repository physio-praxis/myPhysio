...
DROP INDEX "ix_customer_name";--> statement-breakpoint
...
CREATE VIEW "public"."customer_search_view" WITH (security_invoker = true) AS (select "customer"."customer_id", "customer"."created_at", "customer"."first_name", "customer"."last_name", "customer"."email", "customer"."phone_number", "customer"."address", 
					COALESCE(
						STRING_AGG(
							CASE
				 ...
				 as "has_consent" from "customer" left join "pet" on "pet"."customer_id" = "customer"."customer_id" left join "species" on "species"."species_id" = "pet"."species_id" group by "customer"."customer_id", "customer"."created_at", "customer"."first_name", "customer"."last_name", "customer"."email", "customer"."phone_number", "customer"."address");